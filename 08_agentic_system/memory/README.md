...
**文档路径**：[AI 智能体记忆系统：理论与实践](./docs/AI_智能体记忆系统_理论与实践.md)
...
#### 1.2.5 MemMachine 深度解析

**文档路径**：[MemMachine 深度解析](./docs/MemMachine深度解析.md)

**适用对象**：系统架构师、高级开发者

**主要内容**：

- **创新架构**：MemMachine 重新定义智能体交互体验与长记忆管理的核心架构
- **技术原理**：长程记忆和上下文处理机制

#### 1.2.6 LangChain 记忆功能实现
...
- [多轮指代消解对话系统源码](./code/README.md) - 基于深度学习和 NLP 技术的多轮指代消解对话系统完整实现，支持实体识别、状态管理与微服务部署。
- [LangChain 记忆功能实战代码](./langchain/code/README.md) - 包含基础记忆类型、智能客服应用和现代 LangGraph 记忆管理的完整可运行演示项目。

**适用对象**：后端开发者、AI 应用工程师

**主要内容**：

- **端到端实现**：完整的代码结构、微服务部署以及实际演示项目
- **工程实践**：FastAPI 集成、状态管理和微服务架构的最佳实践
