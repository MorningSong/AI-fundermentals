...
- [README](https://github.com/Hmbown/DeepSeek-TUI)：总览与最新动态。
- [安装指南](https://github.com/Hmbown/DeepSeek-TUI/blob/main/docs/INSTALL.md)：更详细的安装指南。
- [模式说明](https://github.com/Hmbown/DeepSeek-TUI/blob/main/docs/MODES.md)：深入理解审批与安全模式。
- [MCP 扩展](https://github.com/Hmbown/DeepSeek-TUI/blob/main/docs/MCP.md)：学习如何扩展自定义工具。
- [配置指南](https://github.com/Hmbown/DeepSeek-TUI/blob/main/docs/CONFIGURATION.md)：配置专属 Agent。
...
3. **详细安装说明（万一 npm 装不上，这里有各种备用方案）**
   `https://github.com/Hmbown/DeepSeek-TUI/blob/main/docs/INSTALL.md`
