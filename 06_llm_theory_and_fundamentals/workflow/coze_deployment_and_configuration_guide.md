...
注意：所有目录都基于项目根目录（即 docker-compose.yml 所在目录）的相对路径。
...
export MINIO_DEFAULT_BUCKETS=opencoze,milvus   # 默认存储桶
...
export EMBEDDING_MAX_BATCH_SIZE="100"             # 批处理大小（字符串格式）
```
