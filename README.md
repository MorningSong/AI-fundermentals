...
- [**基于 LLM 的意图检测**](06_llm_theory_and_fundamentals/llm_basic_concepts/intent_detection/intent_detection_using_llm.zh-CN.md) - 意图识别系统设计与实现
  - 参见：[ChatBox 意图识别与语义理解](06_llm_theory_and_fundamentals/llm_basic_concepts/intent_detection/chatbox_intent_recognition_and_semantic_understanding.md)
...
- [**DeepWiki 技术原理**](06_llm_theory_and_fundamentals/deep_research/deepwiki/deepwiki_usage_and_technical_analysis.md) - DeepWiki 使用方法与技术原理深度分析

### 11.3 特定领域应用

本节展示 RAG 和自然语言理解技术在特定领域的应用案例。

- [**ChatBox 意图识别**](06_llm_theory_and_fundamentals/llm_basic_concepts/intent_detection/chatbox_intent_recognition_and_semantic_understanding.md) - 意图识别与语义理解机制解析
