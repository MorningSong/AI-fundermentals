...
- `multi_agent_system/src/communication/message_bus.py` - 智能体通信机制
- `multi_agent_system/src/communication/` - 通信机制实现
- `multi_agent_system/src/examples/customer_service_system.py` - 企业级客服系统案例
...
class MessagePayload:
    """消息载荷"""
    action: str  # from message.payload.parameters
