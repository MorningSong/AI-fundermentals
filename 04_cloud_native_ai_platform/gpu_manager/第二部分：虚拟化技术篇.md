...
- [GPU 虚拟化与资源管理技术深度解析 - 第二部分：虚拟化技术篇](#gpu-虚拟化与资源管理技术深度解析---第二部分虚拟化技术篇)
  ...
  - [7. 用户态 GPU 虚拟化技术](#7-用户态-gpu-虚拟化技术)
    ...
    - [7.3 HAMi-core 性能优化机制](#73-hami-core-性能优化机制)
      ...
      - [7.3.6 HAMi 性能调优最佳实践](#736-hami-性能调优最佳实践)
...
> **集成应用**： HAMi 环境下的 MIG 自动化管理见 [9.1.2 HAMi MIG Device Plugin 实现](第三部分：资源管理与优化篇.md#912-hami-mig-device-plugin-实现)
 ...
 * @note 详细实现参见 @ref 9.1.2 "HAMi MIG Device Plugin 实现"
 */
...
1. **容器化环境**：为 Docker 、 Kubernetes 等容器提供 GPU 资源隔离，详见 [7.2 HAMi 实现原理深度解析](#72-hami-实现原理深度解析)
2. **多租户云平台**：在云环境中为不同租户提供独立的 GPU 资源，相关安全机制见 [8.2 GPU 虚拟化的核心挑战](#82-gpu-虚拟化的核心挑战)
3. **高性能计算集群**：在 HPC 环境中实现 GPU 资源的细粒度管理，调度算法详见 [10.4 GPU 资源管理核心算法](第三部分：资源管理与优化篇.md#104-gpu-资源管理核心算法)
4. **AI 训练平台**：为机器学习训练任务提供资源隔离和调度，大模型优化见 [10.5 AI 大模型训练场景 GPU 资源管理优化](第三部分：资源管理与优化篇.md#105-ai-大模型训练场景-gpu-资源管理优化)
...
- **资源控制精确**：可以实现细粒度的资源分配和调度，算法实现见 [10.4 GPU 资源管理核心算法](第三部分：资源管理与优化篇.md#104-gpu-资源管理核心算法)
- **系统集成度高**：与操作系统调度器深度集成，与 CUDA 流技术结合见 [11. CUDA 流和 MPS 技术](第三部分：资源管理与优化篇.md#11-cuda-流和-mps-技术)
...
**HAMi-core 环境变量配置：** 详见 [9.1 HAMi 结合硬件级 GPU 切分技术](第三部分：资源管理与优化篇.md#91-hami-结合硬件级-gpu-切分技术)
